...
export function MusicPlayer() {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleMute}
        className={`fixed top-4 right-4 z-50 bg-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-xl p-3 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-cyan-500/25 ${
          audioLoaded 
